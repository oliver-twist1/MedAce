            ...
            <div class="product-price-box mt-25">
                ...
                <?php elseif($product->price > 0): ?>
                    <?php if($product->getPriceWithActiveDiscountPrice() < $product->price): ?>
                        <span class="real"><?php echo e(($product->getPriceWithActiveDiscountPrice() > 0) ? handlePrice($product->getPriceWithActiveDiscountPrice(), true, true, false, null, true, 'store') : trans('public.free')); ?></span>
...
<?php /**PATH /www/wwwroot/demo.medace.org/resources/views/web/default/products/includes/card.blade.php ENDPATH**/ ?>